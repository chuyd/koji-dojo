...
docker run --privileged=true -ti --name=koji-builder -v /opt/koji:/opt/koji -v /opt/koji-files:/mnt/koji --link koji-dojo_koji-db_1 --link koji-dojo_koji-hub_1 docker.io/buildchimp/koji-dojo-builder:dev
